...
public:
    ...
    static Matrix4 MakeFrustum(float l, float r, float b, float t,float n, float f);//Frustum  like glFrustum
    
    static Matrix4 MakeFrustum(float fovy,float aspect, float n , float f);//like gluPerspective
    
    static Matrix4 MakeOrtho(float l, float r, float b, float t, float n, float f);//like glOrtho
